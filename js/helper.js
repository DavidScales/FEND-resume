...
var HTMLheaderRole = '<div class=white-text>%data%</div><hr>';
...
var HTMLemail = '<li class="flex-item"><a href="mailto:%data%?&amp;subject=I%20saw%20your%20resume%20today"><span class="blue-text">email</span><span class="white-text">%data%</span><a></li>';
var HTMLtwitter = '<li class="flex-item"><span class="blue-text">twitter</span><span class="white-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><a href="https://github.com/%data%" target="_blank"><span class="blue-text">github</span><span class="white-text">%data%</span><a></li>';
...
var HTMLbioPic = '<img src="%data%" class="biopic" alt="very handsome face">';
var HTMLwelcomeMsg = '<span class="welcome-message">%data%</span>';

var HTMLskillsStart = '<h3 id="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul>';
var HTMLskills = '<li class="skill-item"><span class="white-text">%data%</span></li>';
...
var HTMLworkPointsStart = '<br><ul class="points"></ul>';
var HTMLworkPoint = '<li class="point">%data%</li>';
...
var HTMLprojectPointsStart = '<br><ul class="points"></ul>';
var HTMLprojectPoint = '<li class="point">%data%</li>';
...
var HTMLschoolAchievement = '<p>%data%</p>';
